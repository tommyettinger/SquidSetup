...
public class ProjectBuilder {
	...
	public List<String> buildProject(List<DependencyBank.ProjectType> projects, List<Dependency> dependencies) {
		List<String> incompatibilities = new ArrayList<String>();
		for (Dependency dep : dependencies) {
			for (DependencyBank.ProjectType type : projects) {
	...
	public boolean build() throws IOException {
		...
		try {
			...
			for (DependencyBank.ProjectType module : modules) {
